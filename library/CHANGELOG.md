...
- 安全性：移除了源码引用ohos/mail部分中不安全的hasOwnProperty调用

# 1.5.16 (2025-06-09)

- 修复：修复潜在的陷入死循环的问题
- 新增：新增makeMessage单元测试

# 1.5.15 (2025-06-07)

- 修复：修复同时使用useWorker和encryptor时，出现异常的问题
- 新增：新增单元测试
